export default {
  plugins: {
    ...
    runtimeNotice: 'Plugin installation, enable/disable, and configuration are handled dynamically by the ChiRe API host and normally do not require a host restart. Restart only when the host version or host configuration changes according to your deployment process.',
    ...
    emptyHint: 'Select a local .s2plugin package. ChiRe API never downloads third-party plugins automatically.',
    configure: 'Configure',
    enable: 'Enable',
    disable: 'Disable',
    test: 'Test',
    ...
    currentVersion: 'Current ChiRe API',
    ...
    confirmDisable: 'Disable this plugin? New OAuth requests immediately return to the built-in ChiRe API path.',
    confirmUninstall: 'Uninstall this plugin? It must be disabled first. Installed files and configuration will be removed.',
    confirmUntested: 'This plugin is compatible but has not declared the current ChiRe API version as tested. Enable it anyway?',
