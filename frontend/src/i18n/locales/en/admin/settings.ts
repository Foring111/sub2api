export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for ChiRe API end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for ChiRe API end-user login',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, ChiRe API temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream ChiRe API sites. Account rates change only when the separate sync switch is enabled.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on ChiRe API orders; the upstream type is sent as EasyPay type.',
      ...
      openaiFastPolicy: {
        ...
        userIdsHint: 'Type any part of a user email to search. Leave empty to apply to all ChiRe API users. Selected users match requests from their API keys and take precedence over global rules.',
