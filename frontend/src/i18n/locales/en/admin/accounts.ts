export default {
    accounts: {
      ...
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. ChiRe API cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      grok: {
        ...
        ttsTextPlaceholder: 'Example: Hello from ChiRe API connectivity test.',
        ttsTextDefault: 'Hello from ChiRe API account connectivity test.',
